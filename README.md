...
<!-- ARXIV-DAILY:START -->
## GUI Agent Memory Papers (updated 2026-06-17)

Tracked categories: `cs.AI, cs.LG, cs.CL, cs.HC, cs.CV`

Found `21` matching papers in the cumulative list.
...
6. **CAPED: Context-Aware Privacy Exposure Defense for Mobile GUI Agents**
   - Authors: Siyu Shen, Fenghao Xu, Wenrui Diao, Kehuan Zhang
...
7. **Somewhere Over the Desktop: A Research Agenda for Ubiquitous Analytics**
...
8. **Speculative Rollback Correction for Quality-Diverse Web Agent Imitation**
...
10. **MemVenom: Triggered Poisoning of Multimodal Memories in Web Agents**
...
15. **AsyncWebRL: Efficient Multi-Step RL for Visual Web Agents**
   - Authors: Hao Bai, Rui Yang, Chenlu Ye, Spencer Whitehead, Aviral Kumar, et al.
...
16. **Online Skill Learning for Web Agents via State-Grounded Dynamic Retrieval**
...
17. **Demo2Tutorial: From Human Experience to Multimodal Software Tutorials**
...
18. **OpenWebRL: Demystifying Online Multi-turn Reinforcement Learning for Visual Web Agents**
...
20. **Masking Stale Observations Helps Search Agents -- Until It Doesn't: A Regime Map and Its Mechanism**
...
21. **GUITestScape: Towards Open-set Evaluation on Exploratory GUI Testing**
