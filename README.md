...
<!-- ARXIV-DAILY:START -->
## GUI Agent Memory Papers (updated 2026-06-11)

Tracked categories: `cs.AI, cs.LG, cs.CL, cs.HC, cs.CV`

Found `13` matching papers in the cumulative list.
...
1. **Somewhere Over the Desktop: A Research Agenda for Ubiquitous Analytics**
...
4. **WebChallenger: A Reliable and Efficient Generalist Web Agent**
...
7. **AsyncWebRL: Efficient Multi-Step RL for Visual Web Agents**
   - Authors: Hao Bai, Rui Yang, Chenlu Ye, Spencer Whitehead, Aviral Kumar, et al.
...
8. **Online Skill Learning for Web Agents via State-Grounded Dynamic Retrieval**
...
13. **GUITestScape: Towards Open-set Evaluation on Exploratory GUI Testing**
